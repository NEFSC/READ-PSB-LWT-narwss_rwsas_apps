fluidPage(
  ...
  splitLayout(radioButtons("sig_acou", "What do you want to evaluate?", choices = c("Visual Sightings", "Acoustic Detections", "Test"), selected = "Visual Sightings", inline = FALSE),
