      ...
      tabsetPanel(type = "tabs",
                  tabPanel("Aerial Survey",
                           (HTML(paste('<br/>',
                                       ...
                                       '<br/>',
                                       "For <strong>MULTI</strong> flight days, files can be labeled according to this convention:",'<br/>', 
                                       "[YYMMDD].gps, [YYMMDD] <strong>(1)</strong>.eff, [YYMMDD] <strong>(2)</strong>.eff, [YYMMDD] <strong>(1)</strong>.sig, [YYMMDD] <strong>(2)</strong>.sig",
                                       '<br/>',
                                       "You can have as many sig or eff files in a day as you want, but must only have the one GPS file.",
                                       '<br/>',))),
                           position = 'left',
                           br(),
